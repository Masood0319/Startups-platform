  ...
  return (
    <div className="bg-gray-900">
      ...
      <div className="relative isolate px-6 pt-6 lg:px-8">
        <div
          aria-hidden="true"
          className="absolute inset-x-0 -top-25 -z-10 transform-gpu overflow-hidden sm:-top-80"
        >
          <div
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-white/2 hover:ring-white/4">
              Have the best opportunity to get invested.{' '}
